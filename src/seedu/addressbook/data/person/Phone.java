...
public class Phone implements Printable{
	...
	public static final String PHONE_PRINTABLE_SENTENCE = "Phone: ";
	public static final String PHONE_PRIVACY_WARNING = "Phone number is private!";
	...
	public String getPrintableString() {
		if (isPrivate) {
			return PHONE_PRIVACY_WARNING;
		} else {
			return PHONE_PRINTABLE_SENTENCE + value;
		}
	}
